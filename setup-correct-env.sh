...
echo "🔧 Configurando entorno con credenciales correctas de Docker..."
...
echo "✅ Archivo .env configurado con credenciales correctas"
...
echo ""
echo "📋 Base de datos: MySQL Docker (cldc_database)"
