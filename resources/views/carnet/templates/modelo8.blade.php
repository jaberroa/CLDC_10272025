...
<head>
    ...
    <style>
        body {
            ...
            padding: 20px;
            background: #f5f5f5;
            font-family: {{ $personalizado?->fuente_familia ?? 'Arial, sans-serif' }};
        }
    ...
    <div class="carnet-container">
        ...
        <div class="carnet-body">
            ...
            <div class="carnet-details">
                ...
                <div class="carnet-status">ACTIVA</div>
    ...
    <script>
        ...
        function generarQR() {
            ...
            if (qrContainer && typeof QRCode !== 'undefined') {
                ...
                console.error('Contenedor QR no encontrado o librería QRCode no disponible');
                if (qrContainer) {
                    qrContainer.innerHTML = '<div style="text-align: center; color: #666; font-size: 10px;">QR no disponible</div>';
                }
            }
        ...
        // También ejecutar después de un pequeño delay para asegurar que la librería esté cargada
